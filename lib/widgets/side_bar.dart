    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _sideItem(3, Icons.receipt_long_outlined, 'Sales'),
          _sideItem(4, Icons.qr_code_2_rounded, 'Barcode'),
          _sideItem(5, Icons.monetization_on_outlined, 'Expenses'),
          _sideItem(6, Icons.settings_outlined, 'Settings'),
        ],
      ),
    );
  }
