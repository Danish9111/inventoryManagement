    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _sideItem(4, Icons.people_alt_outlined, 'Customers'),
          _sideItem(5, Icons.receipt_long_outlined, 'Reports'),
          _sideItem(6, Icons.qr_code_2_rounded, 'Barcode'),
          _sideItem(7, Icons.monetization_on_outlined, 'Expenses'),
          _sideItem(8, Icons.settings_outlined, 'Settings'),
        ],
      ),
    );
  }
